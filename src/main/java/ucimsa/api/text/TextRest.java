...
public class TextRest {
  ...
  @GetMapping("/heap/{id}")
  public ResponseEntity<Optional<HeapText>> getHeapText(@PathVariable("id") int id, Principal principal) throws UserValidatorException {
    final var text = textService.getText(id, principal.getName());
    return ResponseEntity.ok(text);
  }

  @DeleteMapping("/heap/{id}")
  public ResponseEntity<Integer> deleteHeapText(@PathVariable("id") int id, Principal principal) throws UserValidatorException {
  ...
  @PostMapping("/heap")
  public ResponseEntity<HeapText> postHeapText(HeapText heapText, Principal principal) throws UserValidatorException {
